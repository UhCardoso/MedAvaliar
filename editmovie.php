            ...
            <div class="col-md-6 offset-md-1">
                ...
                <form id="edit-movie-form" method="post" action="<?= $BASE_URL ?>/movie_process.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="title" class="form-control" type="text" id="title" placeholder="Digite um título para o seu filme" value="<?= $movie->title; ?>" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="length" class="form-control" name="length" id="length" placeholder="Digite a duração do filme" value="<?= $movie->length; ?>" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" class="form-control" name="trailer" id="trailer" placeholder="Insira o link do trailer" value="<?= $movie->trailer; ?>" />
                    </div>
                    <div class="form-group">
