...
<div id="main-container" class="container-fluid">
    <div class="offset-md-4 col-md-4 new-movie-container">
        ...
        <form action="<?= $BASE_URL ?>/movie_process.php" id="add-movie-form" method="POST" enctype="multpart/form-date">
            <input type="hidden" name="type" value="create" />
            <div class="form-group">
                <label for="title">Título:</label>
                <input class="form-control" type="text" id="title" placeholder="Digite um título para o seu filme" />
            </div>
            <div class="form-group">
